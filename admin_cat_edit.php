...
if(isset($_POST['update'])) { 
    ...
    $sql = "UPDATE `intentory_name` SET `Category`='$Category' WHERE `uid` = '$id'";
    $result = mysqli_query($link, $sql);

    if($result){
        echo "<script type='text/javascript'>alert('Delete Successfully');location='admin_dash.php#cat';</script>";
    }
...
<nav class="navbar-light bg-light ps-5 p-2 pe-5 text-center">
            <div class="container">
              <a class="navbar-brand text-center p-4" href="admin_dash.php">Admin Category Edit</a>

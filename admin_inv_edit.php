...
if(isset($_POST['update'])) { 
    ...
    if($result){
      echo "<script type='text/javascript'>alert('Update Successfully');location='admin_dash.php#inv';</script>";
  }
...
<nav class="navbar-light bg-light ps-5 p-2 pe-5 text-center">
            <div class="container">
              <a class="navbar-brand text-center p-4" href="admin_dash.php">Admin InVentory Edit</a>
...
<tbody class="border bg-light p-5">
  ...
  <tr>
    <td>Price</td>
    <td><input min="0.00" max="10000.00" step="0.01" type="number" class="form-control btn-md" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $user_row['4']?>" name="Price"></td>
  </tr>

...
if(mysqli_num_rows($user_check) > 0 )
{
  ...
  
  {
    ...
    $_SESSION['user_page'] = $user_name ;

    echo "<script type='text/javascript'>alert('Login Successfully !!');location='user.php';</script>";
    ...
    echo "<script type='text/javascript'>alert('Your Account Is Deactive . Please Active Account First !!');location='active_user.php?id=$row[id]';</script>";
  ...
  <div class="row">
    <div class="col">
      <div class="card m-5 border shadow">
        <div class="card-body">
        <div class="">
    <div style="margin:100px;" class="row lg_mt">
